...
![запуск http](images/1.png){ #fig:001 width=70% height=70%}
...
![контекст безопасности http](images/2.png){ #fig:002 width=70% height=70%}
...
![переключатели SELinux для http](images/3.png){ #fig:003 width=70% height=70%}
...
![создание html-файла и доступ по http](images/4.png){ #fig:004 width=70% height=70%}
...
![ошибка доступа после изменения контекста](images/5.png){ #fig:005 width=70% height=70%}
...
![лог ошибок](images/6.png){ #fig:006 width=70% height=70%}
...
![переключение порта](images/7.png){ #fig:007 width=70% height=70%}
...
![доступ по http на 81 порт](images/8.png){ #fig:008 width=70% height=70%}
