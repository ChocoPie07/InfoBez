...
![Добавление пользователей в группу](images/1.png){ #fig:001 width=70% height=70% }
...
![Информация о пользователях](images/2.png){ #fig:002 width=70% height=70% }
...
10.	Меняя атрибуты у директории dir1 и файла file1 от имени пользователя guest и делая проверку от пользователя guest2, заполнили табл. 2, определили опытным путём, какие операции разрешены, а какие нет. Если операция разрешена, занесли в таблицу знак «+», если не разрешена, знак «-».
...
![Изменение прав у директории](images/3.png){ #fig:004 width=70% height=70% }
