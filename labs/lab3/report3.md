...
![Содержимое файла /etc/group и регистрация в группе](images/3.png){ #fig:003 width=70% height=70% }
...
![Изменение прав у директории](images/4.png){ #fig:004 width=70% height=70% }
...
![Заполнение таблицы](images/5.png){ #fig:005 width=70% height=70% }
