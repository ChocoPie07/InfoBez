...
![права доступа](images/1.png){ #fig:001 width=70% height=70%}
...
![атрибут -a](images/2.png){ #fig:002 width=70% height=70%}
...
![атрибут -a снят](images/3.png){ #fig:003 width=70% height=70%}
...
![атрибут -i](images/4.png){ #fig:004 width=70% height=70%}
