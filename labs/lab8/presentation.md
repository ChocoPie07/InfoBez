...
![Работа алгоритма гаммирования](images/000.png){ #fig:001 }

## Пример работы программы

![Работа алгоритма взлома ключа](images/1.png){ #fig:002 }

![Работа алгоритма шифрования и дешивровки](images/2.png){ #fig:003 }
